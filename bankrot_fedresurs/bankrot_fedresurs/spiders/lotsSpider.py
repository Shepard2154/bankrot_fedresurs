...
class LotsSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if classification_flags:
            filter_1_flag = str(classification_flags.get("apartment")).replace('True', '+').replace('False', '')
            filter_2_flag = str(classification_flags.get("empty")).replace('True', '+').replace('False', '')
            filter_3_flag = str(classification_flags.get("house")).replace('True', '+').replace('False', '')
            filter_4_flag = str(classification_flags.get("stead")).replace('True', '+').replace('False', '')
            ...
            loader.add_value("filter_1", filter_1_flag)
            loader.add_value("filter_2", filter_2_flag)
            loader.add_value("filter_3", filter_3_flag)
            loader.add_value("filter_4", filter_4_flag)
            ...
            loader.add_value("deadline_for_accepting_applications", deadline_for_accepting_applications)
            loader.add_value("trading_date", trading_date)
            loader.add_value("filter_1", "")
            loader.add_value("filter_2", "")
            loader.add_value("filter_3", "")
            loader.add_value("filter_4", "")
            yield loader.load_item()
